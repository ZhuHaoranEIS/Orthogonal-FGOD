...
from mmdet.models.dense_heads import MORE_AnchorFreeHead
...
class MORE_RotatedAnchorFreeHead(MORE_AnchorFreeHead):
    ...
    def __init__(self,
                 ...
                 init_cfg=dict(
                     ...
                     override=dict(
                         ...
                         std=0.01,
                         bias_prob=0.01))):
        super(MORE_AnchorFreeHead, self).__init__(init_cfg)

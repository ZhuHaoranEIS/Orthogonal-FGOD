...
class OPL_RotatedFCOSHead(OLRotatedAnchorFreeHead):
    ...
    def forward_single(self, x, scale, stride):
        ...
        """
        cls_score, bbox_pred, cls_feat, reg_feat, cls_feat_bank = super().forward_single(x)
        ...
        return cls_score, bbox_pred, angle_pred, centerness, cls_feat_bank[-2]

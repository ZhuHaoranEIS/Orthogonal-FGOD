...
class RotatedStandardRoIHead(BaseModule, metaclass=ABCMeta):
    ...
    def forward_dummy(self, x, proposals):
        ...
        if self.with_bbox:
            bbox_results, cls_feat = self._bbox_forward(x, rois)
    ...
    def _bbox_forward(self, x, rois):
        ...
        cls_score, bbox_pred, cls_feat = self.bbox_head(bbox_feats)

        bbox_results = dict(
            cls_score=cls_score, bbox_pred=bbox_pred, bbox_feats=bbox_feats)
        return bbox_results, cls_feat
    ...
    def _bbox_forward_train(self, x, sampling_results, gt_bboxes, gt_labels,
        ...
        loss_bbox = self.bbox_head.loss(bbox_results['cls_score'],
                                        bbox_results['bbox_pred'], cls_feat, rois,
                                        *bbox_targets)
